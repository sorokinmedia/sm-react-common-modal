...
function ModalForm(props) {
	return React__default.createElement(
		...
		React__default.createElement(
			ModalHeader,
			null,
			React__default.createElement(ModalClose, { onClick: props.closeModal }),
			React__default.createElement(
				ModalTitle,
				null,
				props.title
...
var FancySpinner = (function (_ref) {
	var size = _ref.size,
	    color = _ref.color;

	var colorTo = color || '#fff';
	return React__default.createElement('div', { className: 'loader4', style: {
			width: size + 'px',
			height: size + 'px',
...
var Button = (function (_ref) {
	...
	return React__default.createElement(
		...
		loading ? React__default.createElement(
			...
			React__default.createElement(FancySpinner, { size: 20, color: color })
		) : ''
	);
});

var ModalButtons = function (_Component) {
	inherits(ModalButtons, _Component);
	...
	function ModalButtons() {
		...
		classCallCheck(this, ModalButtons);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ModalButtons.__proto__ || Object.getPrototypeOf(ModalButtons)).call.apply(_ref, [this].concat(args))), _this), _this.handleCancel = function (ev) {
			ev.preventDefault();
			_this.props.onCancel();
		}, _temp), possibleConstructorReturn(_this, _ret);
	}

	createClass(ModalButtons, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    ...
			    successStyle = _props.successStyle;
			...
			return React__default.createElement(
				...
				React__default.createElement(
					Button,
					{ loading: loading, style: successStyle },
					successText
				),
				React__default.createElement(
					'button',
					{ className: 'btn btn-default btn-flat pull-right', onClick: this.handleCancel },
					'\u041E\u0442\u043C\u0435\u043D\u0430'
				)
			);
		}
...
var ModalButtons$1 = reactRedux.connect(function (state) {
	return {};
}, {})(ModalButtons);
...
exports.ModalButtons = ModalButtons$1;
